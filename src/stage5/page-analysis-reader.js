...
function cloneDiagnostics(value) {
  return {
    ...
    unknownFeatureCount: value.unknownFeatureCount,
    usableFeatureCount: value.usableFeatureCount,
    scoreMargin: value.scoreMargin,
    collapseRiskHint: value.collapseRiskHint,
