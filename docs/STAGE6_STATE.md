...
- Stage 6G-Fix：测试成本隔离已完成，状态 CONDITIONAL_PASS。
  ...
  - Cloudflare 线上基础访问验证通过，但 Dashboard 最新部署 commit 仍需人工确认。
